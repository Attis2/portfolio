  ...
  return (
    <div className="text-white pt-16 pb-16">
      <h1 className="text-center text-2xl md:text-4xl xl:text-5xl font-bold text-white">
        My <span className="text-pink-300">Skills (Placeholders)</span>
      </h1>
          ...
          return (
            <Tilt key={skil.name} scale={1.5} transitionSpeed={400}>
              <div
                ...
                className="bg-[#33134145] text-center w-40 h-48 rounded-3xl flex flex-col items-center justify-center shadow-lg transition hover:scale-75"
              >
