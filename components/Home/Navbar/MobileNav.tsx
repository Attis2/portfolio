...
const MobileNav = ({ closeNav, showNav }: Props) => {
  ...
  return (
    <div>
      ...
      {/* navlinks */}
      <div
        className={`text-white ${navOpen} fixed justify-center flex flex-col h-full transform transition-all duration-500 delay-300 w-[80%] sm:w-[60%] bg-purple-800 space-y-6 z-[1000050] right-0`}
      >
        {NavLinks.map((link) => {
          return (
